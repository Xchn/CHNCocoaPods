...
#s.vendored_frameworks  = 'BSKPlayer/PlayerSDK/TXLiteAVSDK_Smart.framework'
s.vendored_frameworks = 'CHNShare/QQSDK/TencentOpenAPI.framework'
#s.vendored_libraries = "CHNShare/QQSDK/**/*.a"
