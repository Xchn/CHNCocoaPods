...
BSKShare Just Test
  ...
  s.frameworks = 'Security', 'SystemConfiguration', 'CoreGraphics',  'CoreTelephony', 'QuartzCore', 'ImageIO', 'CoreText'
  #s.libraries = 'libstdc++.tbd', 'libz.dylib', 'libz.1.1.3.tbd'
  ...
  s.resource = 'BSKShare/QQSDK/TencentOpenApi_IOS_Bundle.bundle'
